...
try:
    ...
    pass
try:
    sys.path.append(r"D:\Red_Oak_Project\python\final")
except:
    pass
...
import fmeobjects
global wrkspacepath
wrkspacepath = r"D:\Red_Oak_Project\workspaces\tractToPlat.fmw"
...
def platsinglepage(cen,tractnumber):
    ...
    if scale == 30: return "Tract To Large To Plat Use Multipage"
    dimoffset = (1/scale)*.1
    ...
    if len(rowintersections)>0:
        ...
        if len(atwsintersections)>0:
            insertlist,char = createROWDim(tractcenterline,newgdb,dimppoint,viewportpointlayer,twss=twsintersections,row=rowtotalshape)
